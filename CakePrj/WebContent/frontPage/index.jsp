...
<!-- //Custom Theme files -->
<link href="/CakePrj/static/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
<link href="/CakePrj/static/css/style.css" type="text/css" rel="stylesheet" media="all">
<!-- js -->
<script src="/CakePrj/static/js/jquery.min.js"></script>
<script type="text/javascript" src="/CakePrj/static/js/bootstrap-3.1.1.min.js"></script>
<script type="text/javascript" src="/CakePrj/static/js/jquery-3.2.1.min.js"></script>
<!-- //js -->	
<!-- cart -->
<script src="/CakePrj/static/js/simpleCart.min.js"> </script>
<!-- cart -->
...
<body>
					...
					<div id="loginBox">                
						<form id="loginForm" action="/CakePrj/user/signin">
							<fieldset id="body">
								...
								<label for="checkbox"><input type="checkbox" id="checkbox" name="check"> <i>Remember me</i></label>
							</fieldset>
	...
	<div class="banner">
		<div class="container">
			...
			<a href="/CakePrj/cake/products">SHOP NOW</a>
			<div class="banner-text">			
				<img src="/CakePrj/static/images/2.png" alt=""/>	
			</div>
		</div>
	</div>			
	<!--//banner-->
		...
		<div class="container">
			<div class="gallery-grids">
				<div class="col-md-8 gallery-grid glry-one">
					<a href="products.html"><img src="/CakePrj/static/images/g1.jpg" class="img-responsive" alt=""/>
				...
				<div class="col-md-4 gallery-grid glry-two">
					<a href="products.html"><img src="/CakePrj/static/images/g2.jpg" class="img-responsive" alt=""/>
				...
				<c:forEach var = "cake" items="${allCakeList }" begin = "${(pageIndex-1)*8}" end="${(pageIndex*8)-1}">
					<div class="col-md-3 gallery-grid ">
						<a href="/CakePrj/cake/single?cakeId=${cake.cakeId}">		
							<img src="/CakePrj/static/images/${cake.img}" alt=""  class="img-responsive"/>
							
							<div class="gallery-info">
								<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> view</p>
								<a class="shop" href="/CakePrj/cake/single?cakeId=${cake.cakeId}">SHOP NOW</a>
								<div class="clearfix"> </div>
							</div>
						</a>
						<div class="galy-info">
